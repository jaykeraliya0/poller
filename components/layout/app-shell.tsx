...
/**
 * Signed-in chrome: a sidebar on wide screens, a compact top bar on phones.
 * The whole `(app)` area sits in here, and so does a public poll page once
 * there's a session, so the sidebar doesn't vanish halfway through a visit.
 */
